...
(function ($, Drupal, window) {
  "use strict";
  Drupal.behaviors.collapsecustom = {
    attach: function () {
      ...
      $("#block-talmainmenu .dropdown").hover(
        function () {
          ...
          $(".dropdown-menu", this).stop(true, true).delay(100).fadeIn("slow");
          $(this).toggleClass("open");
        },
        function () {
          //$(".dropdown-menu", this).stop(true, true).fadeIn(10);
          if($(this).hasClass('search-menu')){
            $(".dropdown-menu", this).stop(true, true).fadeIn(10).delay(1000).fadeOut("fast");
          }
          else{
  ...
  Drupal.behaviors.changeToggle = {
    attach: function () {
      $("#changetoggle").once().click(function () {
  ...
  Drupal.behaviors.responsiveVideoJS = {
    attach: function (context) {
      window.addEventListener("load", function(event) {
        ...
        $('.slicknav').each(function(i,obj){
        var arr_height = $(obj).height();
        $(this).css('line-height', arr_height+"px");
      });
      });
    ...
    Drupal.behaviors.responsiveBanner = {
      attach: function (context) {
    var top_distance = $('#myCarousel .carousel-inner').outerHeight() / 2 + 5;

		if($(window).width() <= 480){
          top_distance = $('#myCarousel .carousel-inner .mobile-banner-img').outerHeight() / 2 + 5;
		  var highestBox = 0;
		  $('.tal--banner-background-image .carousel-caption .promo-area').height("auto");
		  $('.tal--banner-background-image .carousel-caption .promo-area').each(function(){
			if($(this).height() > highestBox) {
			  highestBox = $(this).height();
		    }
		  });
		  $('.tal--banner-background-image .carousel-caption .promo-area').height(highestBox+5);
		}
		else{
			$('.tal--banner-background-image .carousel-caption .promo-area').height("auto");
		}
    ...
    $('.slicknav').each(function(i,obj){
      ...
      $(this).css('line-height', arr_height+"px");
        ...
        $('.tal--banner-background-image .carousel-control .glyphicon-menu-left').css({"top" : top_distance});
        $('.tal--banner-background-image .carousel-control .glyphicon-menu-right').css({"top" : top_distance});
        window.addEventListener("load", function(event) {

          var top_distance_fw = $('#fullWidthCarousel .carousel-inner').outerHeight() / 2 + 5;

          $('.block--homepage-banner-full-width .tal--banner-background-image .carousel-control .glyphicon-menu-right').css({"top" : top_distance_fw}).show();
          $('.block--homepage-banner-full-width .tal--banner-background-image .carousel-control .glyphicon-menu-left').css({"top" : top_distance_fw}).show();

          if($('div.item.slide-0 .promo-area').hasClass('text-color-indicator-wrapper-white')) {
              $('#myCarousel .carousel-indicators').removeClass('text-color-black');
              $('#myCarousel .carousel-indicators').addClass('text-color-white');
              $('#fullWidthCarousel .carousel-indicators').removeClass('text-color-black');
              $('#fullWidthCarousel .carousel-indicators').addClass('text-color-white');

          }
          else if($('div.item.slide-0 .promo-area').hasClass('text-color-indicator-wrapper-black')) {
              $('#myCarousel .carousel-indicators').removeClass('text-color-white');
              $('#myCarousel .carousel-indicators').addClass('text-color-black');
              $('#fullWidthCarousel .carousel-indicators').removeClass('text-color-white');
              $('#fullWidthCarousel .carousel-indicators').addClass('text-color-black');
          }
          if($('#myCarousel .carousel-inner .item').length < 2) {
              $('#myCarousel .carousel-inner .item .carousel-control').css({"display" : 'none'});
          }

          if($('#fullWidthCarousel .carousel-inner .item').length < 2) {
              $('#fullWidthCarousel .carousel-inner .item .carousel-control').css({"display" : 'none'});
          }
      ...
      $('.block--homepage-banner-full-width .tal--banner-background-image .carousel-control .glyphicon-menu-left').css({"top" : top_distance_fw}).show();
        ...
        $("#myCarousel").swipeleft(function() {
          ...
          $("#myCarousel").bind("slide.bs.carousel", function(event){
              ...
              $( "div.item" ).each(function( index ) {
                  if($(this).hasClass('slide-' + to)) {
                    if($('div.item.slide-' + to + ' .promo-area').hasClass('text-color-indicator-wrapper-white')) {
                        $('#myCarousel .carousel-indicators').removeClass('text-color-black');
                        $('#myCarousel .carousel-indicators').addClass('text-color-white');

                    }
                    else if($('div.item.slide-' + to + ' .promo-area').hasClass('text-color-indicator-wrapper-black')) {
                        $('#myCarousel .carousel-indicators').removeClass('text-color-white');
                        $('#myCarousel .carousel-indicators').addClass('text-color-black');
                    }
                  }
          ...
          $("#fullWidthCarousel").bind("slide.bs.carousel", function(event){
              var carouselData = $(this).data('bs.carousel');
              var currentIndex = $('div.active').index() + 1;
              var next = $(event.relatedTarget);
              var to = next.index();
    ...
    Drupal.behaviors.leadershipblocknewdesign = {
    attach: function (context) {

      var tdo_height = 0;
      $(window).load(function(){
        if($(window).width() > 1024){
          $(".title-desg-overlay").show();
          $(".title-desg-overlay").each(function(){
           var crnt_height = parseInt($(this).height());
            if( crnt_height > tdo_height){
             tdo_height = crnt_height;
            }
          });
          /*$(".title-desg-overlay").height(tdo_height).css("visibility", "visible").hide();
          if(!$('#profile-picture-dpdwn').hasClass('img-tgl-active')){
            $(".title-desg-overlay").show();
          }*/

          $(".title-desg-overlay").height(tdo_height).css("visibility", "visible");
        }

        $('.block--leadership--team--new .person, .block--leadership--team--nutrition-experts .person').once('personhover').mouseover(function(e){
          e.stopPropagation();
          $(this).find('img').attr('title', '');
          if($(window).width() > 1024){
            /*var isProfile = $('#profile-picture-dpdwn').hasClass('img-tgl-active');
            if(isProfile){
              $(this).find(".title-desg-overlay").slideDown();
            }
            else{
              $(this).find(".title-desg-overlay").slideUp();
            }*/
            $(this).find(".title-desg-overlay").slideUp();
          }
          else{
        ...
        $('.img-tgl-container .btn').click(function(e){
          /*var elId = $(this).attr('id');*/
          if(!$(this).hasClass('img-tgl-active')){
            $('.img-tgl-container .btn').removeClass('img-tgl-active');
            $(this).addClass('img-tgl-active');
            $(".person .field_profile_picture, .person .field_webinar_image, .person .field_image, .ldr-images-container .field--name-field-profile-picture, .ldr-images-container .field--name-field-webinar-image, .ldr-images-container .field--name-field-image").slideUp(0);
            $('.person ' + $(this).attr("data-fname") + ', .ldr-images-container ' + $(this).attr("data-fname")).slideDown(0);

            $('.img-tgl-container-mobile  a').removeClass('img-tgl-mobile-active');
            $($(this).attr("data-alt")).addClass('img-tgl-mobile-active');
          }
          /*if(elId !== 'profile-picture-dpdwn'){
            $(".title-desg-overlay").slideDown();
          }
          else{
            $(".title-desg-overlay").slideUp();
          }*/

        });

        $('.img-tgl-container-mobile a').click(function(){
            if(!$(this).hasClass('img-tgl-mobile-active')){
              $('.img-tgl-container-mobile a').removeClass('img-tgl-mobile-active');
              $(this).addClass('img-tgl-mobile-active');
              $(".person .field_profile_picture, .person .field_webinar_image, .person .field_image").slideUp(0);
              $('.person ' + $(this).attr("data-fname")).slideDown(0);

              $('.img-tgl-container .btn').removeClass('img-tgl-active');
              $($(this).attr("data-alt")).addClass('img-tgl-active');
            }
        });

        $(".img-tgl-btn-box .btn").click(function(){
          if(!$(this).hasClass('img-tgl-active')){
            $('.img-tgl-btn-box .btn').removeClass('img-tgl-active');
            $(this).addClass('img-tgl-active');
            $(".ldr-images-container .field--name-field-profile-picture, .ldr-images-container .field--name-field-webinar-image, .ldr-images-container .field--name-field-image").slideUp(0);
            $('.ldr-images-container ' + $(this).attr("data-fname")).slideDown(0);
          }
        });
      ...
      $(window).resize(function(){
        if($(window).width() > 1024){
          ...
          $(".title-desg-overlay").height(tdo_height);
          $(".title-desg-overlay").hide().css('visibility', 'visible').show();
        }
        else{
          $(".title-desg-overlay").height('auto');
          $(".title-desg-overlay").show();
        }
      });

      $('#block-mainnavigation .navbar .navbar-nav li').mouseover(function(){
        $(this).addClass('open');
      });
      $('#block-mainnavigation .navbar .navbar-nav li').mouseleave(function(){
        $(this).removeClass('open');
      });

      $('#block-multilingualmenu .navbar .navbar-nav li').mouseover(function(){
        $(this).addClass('open');
      });
      $('#block-multilingualmenu .navbar .navbar-nav li').mouseleave(function(){
        $(this).removeClass('open');
      });
  ...
  $(window).load(function(){
   $('#slick-views-articles-post-block-6-1-slider .slick-track').attr('aria-label', 'latest news carousel');
   $("#block-mobile-menu .input--wrapper input").attr("id", "tal-edit-search-page-mobile");
   $("#block-mobile-menu .input--wrapper input").attr("data-drupal-selector", "tal-edit-search-page-mobile");
   $("#block-mobile-menu .select-wrapper select").attr("id", "edit-sort-by-mobile");
   $("#block-mobile-menu .select-wrapper select").attr("data-drupal-selector", "edit-sort-by-mobile");
  });

  $('.fiber-radio-option').click(function(e){

    var slnxt = $(this).closest('.slick');
    $(slnxt).find('.slick-next').click();
  });

  $("#start-calculator").click(function(e){ e.preventDefault();
    $('#portionModal').modal('toggle');
    var secBlock = $(this).closest('.fibre-calc-container')[0];
    var scrollDestination = secBlock.scrollWidth/2;
     var slideTimer = setInterval(function(){
      //console.log(secBlock.scrollLeft, "test1");
      secBlock.scrollLeft = secBlock.scrollLeft + 100;
      if(Math.ceil(secBlock.scrollLeft) >= scrollDestination){
        window.clearInterval(slideTimer);
        $('.slick--view--fibre-calculator nav.slick__arrow').show();
        $('#calculate-fibre').show();
         $(".fibre-calc-container").css("overflow-x", "hidden");
         $(".fibre-calc-container .start-slide-n-calc").addClass('hide-start');
      }
     }, 20);
  ...
  $("#calculate-fibre, .end-slide-n-calc .fiber-radio-option").click(function(e){
    $(".calculating-status").fadeIn();
    $(".slick--view--fibre-calculator .slick__arrow,.slick--view--fibre-calculator #calculate-fibre").hide();
    var blk1 = $(this).closest(".fibre-calc-end-container")[0];//console.log(blk1);
    var selected_options = [];
    $(".fibre-calculator-options").each(function(){
      $(this).find("input[type=radio]:checked").each(function(){
        var single_option = Object();
        single_option.nid = $(this).attr("data-nid");
        single_option.option_text = $(this).attr("data-option-text");
        single_option.value = $(this).val();
        selected_options.push(JSON.stringify(single_option));
      });
    });
    jQuery.ajax({
      url: Drupal.url('tal_admin_config/get_results'),
      type: "POST",
      data: {options: JSON.stringify(selected_options)},
      success: function(result) {
        //console.log(result);

        $('.result-box').empty();
        $('.result-box').text(result.result);
        let bclass = 'f-' + result.result.toLowerCase();
        $('.result-box-wrapper').addClass(bclass);
        $('.result-summary-wrapper').empty();
        $('.result-summary-wrapper').html(result.result_description);
        $('#tips-modal').text(result.buttons_labels[0]);
        $('#reset-button').text(result.buttons_labels[1]);
        $('#share-button').text(result.buttons_labels[2]);
        var tips_list = '<div class="additional-tips"><ul>';
        if(result.tips != null) {
          if(Array.isArray(result.tips)){
            $.each( result.tips, function( index, value ){
              tips_list += '<li>'+value+'</li>';
            });
          }
          else{
            tips_list += '<li>'+result.tips+'</li>';
          }
        }
        tips_list += '</ul></div>';
        $('#portionModal .modal-body').html(tips_list);
        $('#result-circ-image').attr('src', result.result_image);
        setTimeout(function(){
          $(".calculating-status").fadeOut();
          var scrollDestination = blk1.scrollWidth/2;
          var slideresTimer = setInterval(function(){
          //console.log(scrollDestination);
          blk1.scrollLeft = blk1.scrollLeft + 100;
          if(Math.ceil(blk1.scrollLeft) >= scrollDestination){
            window.clearInterval(slideresTimer);
            $(".fibre-calc-end-container").css("overflow-x", "hidden");
            $(".fibre-calc-end-container .end-slide-n-calc").addClass('hide-end');
          }
          }, 20);
        }, 2500);
      }
  ...
  $('.options-info .glyphicon-info-sign').click(function(e){
    var portion_parent = $(this).closest('.calculator-wrapper-options')[0];
    var portion = $(portion_parent).find('.portion-data').html();
    var portion_heading = $(portion_parent).find('.portion-heading').text();
    $('.modal-body').html(portion);
    $('.modal-title').text(portion_heading);
  });

  $('#tips-modal').click(function(e){
    $('#portionModal').modal('toggle');
    $('#portionModal .modal-title').text("Additional Tips").addClass('tips-title');
  });

  $("#toolbar-item-administration").click(function(e){
